...
------------------------------ */
    ...
    public bool CanDoDifficultCombat()
    {
        return false;
    }
    ...
    public bool CanGetBugWithLantern()
    {
        return false;
    }
...
------------------------------ */
    ...
    {
        return Has("ShadowCrystal") && CanAccessKakGorge();
    }
    ...
    {
        return Has("Bombs") || CanDoBSMoonBoots() || CanDoJSMoonBoots();
    }
    ...
    {
        return (Has("LTSmallKey", 3) || SettingsStatus["IgnoreKeyLogic"])
        || Has("HiddenSkill", 3)
        || CanDoBSMoonBoots()
        || CanDoJSMoonBoots()
        || CanDoLJA()
...
------------------------------ */
    ...
    {
        return CanUseWaterBombs() || Has("Clawshot");
    }
    ...
    public bool CanDefeatBokoblinRed()
    {
        return Has("Sword")
            ...
            || Has("ShadowCrystal")
            || Has("Bombs")
            || (CanDoDifficultCombat() && (Has("IronBoots") || Has("Spinner")))
            || CanUseBacksliceAsSword();
    }
    ...
    {
        return Has("Sword")
        || (CanDoDifficultCombat() && (Has("Bombs") || Has("B&C")));
    }
    ...
    public bool CanDefeatFireToadpoli()
    {
        return Has("Sword")
            ...
            || (CanDoDifficultCombat() && Has("ShadowCrystal"));
    }
    ...
    public bool CanDefeatGoron()
    {
        return Has("Sword")
            ...
            || CanUseBacksliceAsSword()
            || (CanDoNicheStuff() && Has("IronBoots"))
            || (CanDoDifficultCombat() && Has("Lantern"));
    }
    ...
    public bool CanDefeatGuay()
    {
        return Has("Sword")
            ...
            || Has("ShadowCrystal")
            || Has("Slingshot")
            || (CanDoDifficultCombat() && Has("Spinner"))
            || (CanDoNicheStuff() && Has("IronBoots"));
    }
    ...
    public bool CanDefeatDangoro()
    {
        return Has("IronBoots")
            && (Has("Sword") 
                || Has("ShadowCrystal") 
                || ((CanDoNicheStuff() && Has("B&C")) || (CanBombArrow())));
    }
    ...
    {
        return Has("Bow") || Has("IronBoots") || (Has("Sword") | (CanDoDifficultCombat() && CanUseBacksliceAsSword()));
    }
...
------------------------------ */
    ...
    {
        return CanAccessCastleTown() && Has("Bug", 1);
    }

    public bool AgithaFemaleBeetleReward()
    {
        return CanAccessCastleTown() && Has("Bug", 2);
    }

    public bool AgithaFemaleButterflyReward()
    {
        return CanAccessCastleTown() && Has("Bug", 3);
    }

    public bool AgithaFemaleDayflyReward()
    {
        return CanAccessCastleTown() && Has("Bug", 4);
    }

    public bool AgithaFemaleDragonflyReward()
    {
        return CanAccessCastleTown() && Has("Bug", 5);
    }

    public bool AgithaFemaleGrasshopperReward()
    {
        return CanAccessCastleTown() && Has("Bug", 6);
    }

    public bool AgithaFemaleLadybugReward()
    {
        return CanAccessCastleTown() && Has("Bug", 7);
    }

    public bool AgithaFemaleMantisReward()
    {
        return CanAccessCastleTown() && Has("Bug", 8);
    }

    public bool AgithaFemalePhasmidReward()
    {
        return CanAccessCastleTown() && Has("Bug", 9);
    }

    public bool AgithaFemalePillBugReward()
    {
        return CanAccessCastleTown() && Has("Bug", 10);
    }

    public bool AgithaFemaleSnailReward()
    {
        return CanAccessCastleTown() && Has("Bug", 11);
    }

    public bool AgithaFemaleStagBeetleReward()
    {
        return CanAccessCastleTown() && Has("Bug", 12);
    }

    public bool AgithaMaleAntReward()
    {
        return CanAccessCastleTown() && Has("Bug", 13);
    }

    public bool AgithaMaleBeetleReward()
    {
        return CanAccessCastleTown() && Has("Bug", 14);
    }

    public bool AgithaMaleButterflyReward()
    {
        return CanAccessCastleTown() && Has("Bug", 15);
    }

    public bool AgithaMaleDayflyReward()
    {
        return CanAccessCastleTown() && Has("Bug", 16);
    }

    public bool AgithaMaleDragonflyReward()
    {
        return CanAccessCastleTown() && Has("Bug", 17);
    }

    public bool AgithaMaleGrasshopperReward()
    {
        return CanAccessCastleTown() && Has("Bug", 18);
    }

    public bool AgithaMaleLadybugReward()
    {
        return CanAccessCastleTown() && Has("Bug", 19);
    }

    public bool AgithaMaleMantisReward()
    {
        return CanAccessCastleTown() && Has("Bug", 20);
    }

    public bool AgithaMalePhasmidReward()
    {
        return CanAccessCastleTown() && Has("Bug", 21);
    }

    public bool AgithaMalePillBugReward()
    {
        return CanAccessCastleTown() && Has("Bug", 22);
    }

    public bool AgithaMaleSnailReward()
    {
        return CanAccessCastleTown() && Has("Bug", 23);
    }

    public bool AgithaMaleStagBeetleReward()
    {
        return CanAccessCastleTown() && Has("Bug", 24);
    }
